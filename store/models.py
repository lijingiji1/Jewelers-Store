...
class Address(models.Model):
    ...
    firstname = models.CharField(max_length=150, verbose_name="First Name",null=True)
    lastname = models.CharField(max_length=150, verbose_name="Last Name",null=True)
    email= models.EmailField(max_length=254, verbose_name="Email Address",null=True)
    phone = models.CharField(max_length=150, verbose_name="Phone Number",null=True)
    address = models.CharField(max_length=150, verbose_name="Address Line ",null=True)
